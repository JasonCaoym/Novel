...
public class ShareUtil {
    ...
    public static void shareMedia(Context context, Dialog dialog, @SharePlatform.Platform int platform, String title,
                                  String summary, String targetUrl, Object thumb, ShareListener listener) {
        initShareMediaData(context, TYPE_MEDIA, dialog, platform, listener, null, thumb, false, summary, targetUrl, title, null, null);
    }
     ...
     * @param listener    result listener
     */
    private static void initShareMediaData(Context context, int type, Dialog dialog, int platform, ShareListener listener,
                                           String text, Object imageObject, boolean immediate,
                                           String summary, String targetUrl, String title, String miniId, String miniPath) {
        switch (type) {
            case TYPE_TEXT:
        ...
        mPlatform = platform;
        mShareListener = buildProxyListener(listener);
        _ShareActivity.newInstance(context, TYPE, dialog);
    }
