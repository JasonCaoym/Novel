...
public abstract class AbsPageLoader {
    ...
    public AbsPageLoader(FragmentActivity activity, PageView pageView, String prevPageId, String sourceStats,String bookId) {
        ...
        mAdHeight = mScreenHeight / 2 + Utils.dp2px(context.globalContext, 20);
        initData();
        initPaint();
        initPageView();
    }
...
//                }
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                canvas.saveLayer(mDisplayWidth - Utils.dp2px(context.globalContext, 90), mDisplayHeight - mMarginHeight + ScreenUtils.dpToPx(2), mDisplayWidth, mDisplayHeight, mBgPaint);
                RectF rectF = new RectF(0, 0, mDisplayWidth, mDisplayHeight);
                canvas.drawBitmap(getBgBitmap(), null, rectF, null);
                canvas.restore();
            } else {
                canvas.saveLayer(mDisplayWidth  - Utils.dp2px(context.globalContext, 90), mDisplayHeight - mMarginHeight + ScreenUtils.dpToPx(2), mDisplayWidth, mDisplayHeight, mBgPaint, Canvas.ALL_SAVE_FLAG);
                RectF rectF = new RectF(0, 0, mDisplayWidth, mDisplayHeight);
                canvas.drawBitmap(getBgBitmap(), null, rectF, null);
                canvas.restore();
            }
...
//                }
            ...
            mBgPaint.setColor(mPageBg);
            canvas.drawRect(mDisplayWidth - Utils.dp2px(context.globalContext, 90), mDisplayHeight - mMarginHeight + ScreenUtils.dpToPx(2), mDisplayWidth, mDisplayHeight, mBgPaint);
        }
