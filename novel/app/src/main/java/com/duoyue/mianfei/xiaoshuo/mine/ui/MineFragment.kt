...
import com.zzdm.tinker.util.SampleApplicationContext.application
...
class MineFragment : BaseFragment(), MineView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        join_qq_group.number.compoundDrawablePadding = Utils.dp2px(10f)
    ...
    private fun setTaskRedPoint() {
        val lastTime = SharePreferenceUtils.getLong(application, SharePreferenceUtils.FIRST_CLICK_EVERY_DAY_TASK, 0)
    ...
    private fun initCountDown() {
        cdv_count_down.setTimeTvSize(Utils.sp2px(5f) * 1.0f)
            .setColonMargin(Utils.dp2px(3.5f), Utils.dp2px(3.5f))
            .setTimeTvBackgroundRes(R.drawable.bg_fff7ea)
            .setHourTvPadding(Utils.dp2px(3f), Utils.dp2px(1f), Utils.dp2px(3f), Utils.dp2px(1f))
            .setMinuteTvPadding(Utils.dp2px(3f), Utils.dp2px(1f), Utils.dp2px(3f), Utils.dp2px(1f))
            .setSecondTvPadding(Utils.dp2px(3f), Utils.dp2px(1f), Utils.dp2px(3f), Utils.dp2px(1f))
            .setMinWidth(18f)
...
//                Logger.d("MineFragment--" ,intentUrl)
    ...
    private fun goTaskCenter() {
        ...
        SharePreferenceUtils.putLong(
            application, SharePreferenceUtils.FIRST_CLICK_EVERY_DAY_TASK,
