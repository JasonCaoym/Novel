...
public class NotificationV2Target extends SimpleTarget<Bitmap> {
     ...
     */
    public NotificationV2Target(Context context,
     ...
     *                        May be {@code null}.
     */
    public NotificationV2Target(Context context, int viewId, RemoteViews remoteViews,
     ...
     */
    public NotificationV2Target(Context context, int width, int height, int viewId,
