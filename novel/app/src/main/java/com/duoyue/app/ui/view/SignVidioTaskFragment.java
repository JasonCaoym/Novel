...
public class SignVidioTaskFragment extends DialogFragment {
    ...
    public void onStart() {
        ...
        lp.width = Utils.dp2px(getContext(),270);
        lp.height = Utils.dp2px(getContext(),260);
    ...
    private void initView(View view) {
        ...
        s1.setSpan(new AbsoluteSizeSpan(Utils.dp2px(getContext(),18), true), 3, s1.length()-2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
