...
public class SettingActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        //注销账号.
        mCancelAccountView = findViewById(R.id.cancel_account_click);
        //获取用户信息.
        UserInfo userInfo = UserManager.getInstance().getUserInfo();
        if (userInfo != null && userInfo.type != LoginPresenter.USER_TYPE_TOURIST) {
            //用户已登录, 显示注销账号入口.
            findViewById(R.id.cancel_account_layout).setVisibility(View.VISIBLE);
            mCancelAccountView.setOnClickListener(this);
            //显示退出登录入口.
            mSignOutView.setVisibility(View.VISIBLE);
            mSignOutView.setOnClickListener(this);
        } else {
            //用户未登录.
            findViewById(R.id.cancel_account_layout).setVisibility(View.GONE);
    ...
    public void onClick(@NotNull View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.setting_ignor_battery_click:
                ...
                break;
            case R.id.cancel_account_click:
                //注销账号.
                Intent intent = new Intent(getApplicationContext(), CancelAccountActivity.class);
    ...
    private void exitLogin() {
        ...
        UserLoginMgr.userSignOut(this, new UserLoginCallback() {
            ...
            public void onLoginStart(int type) {
                ...
                {
                    mCancelAccountView.setClickable(false);
                }
                //点击退出登录.
            ...
            public void onLoginSucc(int type, UserInfo userInfo) {
                ...
                if (mCancelAccountView != null)
                {
                    mCancelAccountView.setVisibility(View.GONE);
                }
                try {
                    //发送登录成功广播.
            ...
            public void onLoginFail(int type, String errMsg) {
                ...
                if (mCancelAccountView != null)
                {
                    mCancelAccountView.setClickable(true);
                }
