        ...
        recycleView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (layoutManager instanceof LinearLayoutManager) {
                    ...
                    if (height < Utils.dp2px(364) && height > Utils.dp2px(354)) {
                        ...
                        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, Utils.dp2px(1));
                        params.leftMargin = Utils.dp2px(10);
                        ...
                        View view1 = viewByPosition1.findViewById(R.id.view_devider);
                        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, Utils.dp2px(1));
                        params.leftMargin = Utils.dp2px(0);
                        params.rightMargin = Utils.dp2px(0);
                        view1.setLayoutParams(params);
                    }
                }
            }
