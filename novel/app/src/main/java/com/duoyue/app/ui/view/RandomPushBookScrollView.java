...
public class RandomPushBookScrollView extends ScrollView {
    ...
    public RandomPushBookScrollView(Context context) {

        super(context);

    }

    public RandomPushBookScrollView(Context context, AttributeSet attrs) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                Logger.d(TAG, "dispatchTouchEvent: " + mOffset);
                if (Math.abs(mOffset) >= mNum){
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shouldMove) {
                    ...
                    contentView.layout(originalRect.left, originalRect.top + mOffset, originalRect.right, originalRect.bottom + mOffset);
