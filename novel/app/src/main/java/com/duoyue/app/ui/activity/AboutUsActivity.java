...
public class AboutUsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //隐私政策.
        findViewById(R.id.au_privacy_policy_layout).setOnClickListener(this);
        //退出登录Layout.
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.au_user_agreement_layout:
                ...
                {
                    //此处需要填写默认地址.
                    //url = "http://yhxy.dianzhikeji.com/userAgreement.html";
                ...
                break;
            case R.id.au_privacy_policy_layout:
                //隐私政策.
                url = AdReadConfigHelp.getsInstance().getValueByKey(AdConstants.ReadParams.PRIVACY_POLICY);
                if (TextUtils.isEmpty(url))
                {
                    //此处需要填写默认地址.
                    //url = "http://yhxy.dianzhikeji.com/privacyPolicy.html";
                    url = "http://yhxy.duoyuexiaoshuo.com/privacyPolicy.html";
                }
                //BaseActivityHelper.INSTANCE.gotoWebActivity(this, new WebActivity.Data(DomainConfig.INSTANCE.getAboutH5(), ViewUtils.getString(R.string.about_us)));
                BaseActivityHelper.INSTANCE.gotoWebActivity(this, new WebActivity.Data(url, ViewUtils.getString(R.string.about_us)));
                break;
