...
public class SplashActivity extends BaseActivity implements AdCallbackListener {
     ...
     * 用户协议Dialog.
     */
    private AlertDialog mUserPotolDialog;

    /**
     * 是否已同意用户协议.
     */
    private boolean isAgreeUserPotol;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //获取是否已同意用户协议.
        isAgreeUserPotol =  SPUtils.INSTANCE.getBoolean("userpotodial", false);
        if(!isAgreeUserPotol)
        {
            //展示用户协议.
            showUserPotol();
...
//            }
    ...
    {
        View dialogView = LayoutInflater.from(this).inflate(R.layout.dialog_user_poto,null);
        mUserPotolDialog = new AlertDialog.Builder(this).create();
        mUserPotolDialog.setView(dialogView);
        mUserPotolDialog.setCancelable(false);
        //控制整个dialog透明度
        Window window = mUserPotolDialog.getWindow();
        //WindowManager.LayoutParams lp = window.getAttributes();
        //lp.alpha = 0.9f;
        //window.setAttributes(lp);
        window.setBackgroundDrawable(new ColorDrawable(0));
        TextView txt_exit =  dialogView.findViewById(R.id.txt_exit);
        TextView txt_usersec =  dialogView.findViewById(R.id.txt_usersec);
        txt_usersec.getPaint().setFlags(Paint. UNDERLINE_TEXT_FLAG ); //下划线
        txt_usersec.getPaint().setAntiAlias(true);//抗锯齿
        TextView txt_userPoto =  dialogView.findViewById(R.id.txt_userPoto);
        txt_userPoto.getPaint().setFlags(Paint. UNDERLINE_TEXT_FLAG ); //下划线
        txt_userPoto.getPaint().setAntiAlias(true);//抗锯齿
        txt_exit.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                //退出应用.
                if (mUserPotolDialog != null)
                {
                    mUserPotolDialog.dismiss();
                }
                finish();
            }
        });
        ...
        //隐私政策
        txt_usersec.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Intent dateIntent = new Intent(SplashActivity.this, UserPotoActivity.class);
                //dateIntent.putExtra("url","http://yhxy.dianzhikeji.com/privacyPolicy.html");
                dateIntent.putExtra("url","http://yhxy.duoyuexiaoshuo.com/privacyPolicy.html");
                SplashActivity.this.startActivity(dateIntent);
            }
        });
        //用户协议.
        txt_userPoto.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Intent dateIntent = new Intent(SplashActivity.this, UserPotoActivity.class);
                //dateIntent.putExtra("url","http://yhxy.dianzhikeji.com/userAgreement.html");
                dateIntent.putExtra("url","http://app.duoyueapp.com/user_rules.html");
                SplashActivity.this.startActivity(dateIntent);
            }
        });
        //同意.
        Button btn_agress = dialogView.findViewById(R.id.btn_agree);
        btn_agress.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                SPUtils.INSTANCE.putBoolean("userpotodial", true);
                isAgreeUserPotol = true;
                //初始化Application.
                MainApplication.Companion.initApplication();
                //进入开屏流程.
                gotoSplash();
                //调用onResume展示开屏广告.
                onResume();
