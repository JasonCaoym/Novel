...
public class HuaweiPushRevicer extends PushReceiver {
    ...
    public void onToken(Context context, String tokenIn, Bundle extras) {
        Logger.d(TAG, "onToken: " + tokenIn);
        SPUtils.INSTANCE.putString(PushMgr.SET_HUAWEI_TOKEN, tokenIn);
...
//        callBack(intent);
    ...
    public boolean onPushMsg(Context context, byte[] msg, Bundle bundle) {
        try {
            ...
            Logger.d(TAG, "onPushMsg: " + content);
            Intent intent = new Intent();
            intent.setAction(ACTION_UPDATEUI);
    ...
    public void onEvent(Context context, Event event, Bundle extras) {
        Logger.d(TAG, "onEvent: " + event.name());
        Intent intent = new Intent();
        intent.setAction(ACTION_UPDATEUI);
    ...
    public void onPushState(Context context, boolean pushState) {
        Logger.d(TAG, "onPushState: " + pushState);
        Intent intent = new Intent();
        intent.setAction(ACTION_UPDATEUI);
