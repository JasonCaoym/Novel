...
class StApiRequest {
    ...
    public StApiRequest(String fullUrl, ApiConfigs configs, MtMap<String, String> fields, Type respType) {
    ...
    private StApiRequest(String url) {
        this.mFullUrl = url;
    }

    public static StApiRequest createExternalGetRequest(String url) {
        StApiRequest request = new StApiRequest(url);
        request.mIsExternalReq = true;
        request.mRequestMethod = REQ_METHOD_GET;
        return request;
    }

    public static StApiRequest createExternalPostRequest(String url, MtMap<String, String> params) {
        StApiRequest request = new StApiRequest(url);
        request.mIsExternalReq = true;
