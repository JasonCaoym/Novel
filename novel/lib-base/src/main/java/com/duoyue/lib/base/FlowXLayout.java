...
public class FlowXLayout extends ViewGroup {
    ...
    public FlowXLayout(Context context) {
        this(context, null);
    }

    public FlowXLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowXLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.FlowXLayout);
        mMaxLinesCount = arr.getInteger(R.styleable.FlowXLayout_maxLines, Integer.MAX_VALUE);
        arr.recycle();
    }
