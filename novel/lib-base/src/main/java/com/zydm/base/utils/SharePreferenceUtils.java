...
public class SharePreferenceUtils {
    ...
    public static final String BOOK_DETAIL_CACHE = "bookCacheBean";
    public static final String TASK_LIST_CACHE = "task_list_cache";
    public static final String READ_HISTORY_CACHE = "read_history_cache";
    public static final String FIRST_CLICK_EVERY_DAY_TASK = "first_click_every_day_task";
    public static final String IS_FIRST_IN = "is_first_in";
    public static final String IS_IN_DETAIL = "is_in_detail";
    public static final String FIRST_TIME_EVERY_DAY = "first_time_every_day";
    public static final String DIALOG_SHOW_FIRST_TIME_EVERY_DAY = "dialog_show_first_time_every_day";
    public static final String PREV_APPID = "prev_appid";

    //安装包的版本号
    public static final String UPDATE_FIRST_START = "update_first_start";
    //热更新版本号
    public static final String HOT_UPDATE_FIRST_START = "hot_update_first_start";
